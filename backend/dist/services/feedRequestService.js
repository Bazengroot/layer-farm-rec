...
exports.feedRequestService = void 0;
 ...
 */
exports.feedRequestService = {
    /** Create a new feed request in Draft status */
    async createRequest(params) {
        const { organizationId, farmId, siteId, houseId, flockId, feedTypeId, quantity, unitId, requiredDate, requesterId, reason, } = params;
    ...
    async listRequests(filter) {
        let query = supabaseAdmin_1.supabaseAdmin.from('feed_requests').select('*');
...
//# sourceMappingURL=feedRequestService.js.map