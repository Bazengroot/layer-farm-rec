...
exports.dailyHealthService = void 0;
...
exports.dailyHealthService = {
    ...
    async create(orgId, payload) {
        const { error } = await supabaseAdmin_1.supabaseAdmin.from('daily_health_records').insert({
            id: (0, uuid_1.v4)(),
...
//# sourceMappingURL=dailyHealthService.js.map